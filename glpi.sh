...
echo "${BBlue}Descarrega i descompresio GLPI\n"
...
echo -e "Descomprimint paquet descarregat..."
...
echo -e "Eliminant fitxer a la carpeta html..."
rm -R /var/www/html/
if [ $? -eq 0 ]; then
...
echo -e "Movent arxiu a la cartpeta html..."
...
echo "${BBlue}Instalació php7.4 i activació"
...
if [ $? -eq 0 ]; then
	...
	echo -e "${Green}Apache reinicicat correctament"
...
clear
echo "${BBlue}Creacio base de dades\n"
#Creacio base dades
dbname="glpi"
...
echo "${BBlue}INSTALACIO DE GLPI FETA CORRECTAMENT\n"
